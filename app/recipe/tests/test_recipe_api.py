...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = create_user(
            email="user@example.com", password="testpass123", name="name"
        )
    ...
    def test_partial_update_of_recipe(self):
        ...
        recipe = create_recipe(
            user=self.user, title="Sample recipe1", link=original_link
        )
        url = detail_url(recipe.id)
    ...
    def test_create_a_recipe_with_existing_tags(self):
        ...
        self.assertEqual(tag_indian.name, recipe.tags.first().name)
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        self.assertNotIn(ingredient_egg, recipe.ingredients.all())
